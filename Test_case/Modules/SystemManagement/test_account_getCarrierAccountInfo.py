...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/systemManage/account/getCarrierAccountInfo'
    ...
    def test_001_getCarrierAccountInfo(self):
        #入参
        logger = logging.getLogger('test_001_getCarrierAccountInfo')
        playroad = {"param":{"data":{}}}
