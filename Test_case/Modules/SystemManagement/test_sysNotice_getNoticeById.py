...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/systemManage/sysNotice/getNoticeById'
    ...
    def test_001_getNoticeById(self):
        #入参
        logger = logging.getLogger('test_001_getNoticeById')
        playroad = {"param":{"id":33}}
