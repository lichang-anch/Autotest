...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/systemManage/account/getRechargeRecordPageList'
    ...
    def test_001_getRechargeRecordPageList(self):
        #入参
        logger = logging.getLogger('test_001_getRechargeRecordPageList')
        playroad = {"param":{"startPage":1,"pageSize":10}}
