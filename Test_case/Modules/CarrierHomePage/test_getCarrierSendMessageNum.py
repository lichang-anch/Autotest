...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/systemManage/carrierHomePage/getCarrierSendMessageNum'
    ...
    def test_001_getCarrierSendMessageNum(self):
        #入参
        logger = logging.getLogger('test_001_getCarrierSendMessageNum')
        playroad = {"param":{"data":{}}}
