...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/systemManage/carrierHomePage/selectCarrierSalesTalkInfoList'
    ...
    def test_001_selectCarrierSalesTalkInfoList(self):
        #入参
        logger = logging.getLogger('test_001_selectCarrierSalesTalkInfoList')
        playroad = {"param":{"data":{}}}
