...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/systemManage/carrierHomePage/selectCarrierRegisterInfoList'
    ...
    def test_001_selectCarrierRegisterInfoList(self):
        #入参
        logger = logging.getLogger('test_001_selectCarrierRegisterInfoList')
        playroad = {"param":{"data":{}}}
