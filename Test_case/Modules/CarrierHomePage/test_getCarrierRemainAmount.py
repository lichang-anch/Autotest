...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/systemManage/carrierHomePage/getCarrierRemainAmount'
    ...
    def test_001_getCarrierRemainAmount(self):
        #入参
        logger = logging.getLogger('test_001_getCarrierRemainAmount')
        playroad = {"param":{"data":{}}}
