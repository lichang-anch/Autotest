...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/systemManage/carrierHomePage/getCarrierTotalRechargeAmount'
    ...
    def test_001_getCarrierTotalRechargeAmount(self):
        #入参
        logger = logging.getLogger('test_001_getCarrierTotalRechargeAmount')
        playroad = {"param":{"data":{}}}
