...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/systemManage/carrierHomePage/getCarrierRegisterNum'
    ...
    def test_001_getCarrierRegisterNum(self):
        #入参
        logger = logging.getLogger('test_001_getCarrierRegisterNum')
        playroad = {"param":{"data":{}}}
