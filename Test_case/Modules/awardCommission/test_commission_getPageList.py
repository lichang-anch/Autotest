...
class Test_getnotice:
    ...
    @classmethod
    def setup_class(cls):
        path ='/api/carrier/awardCommission/commission/getPageList'
    ...
    def test_001_getPageList(self):
        #入参
        logger = logging.getLogger('test_001_getPageList')
        playroad = {"param":{"startPage":1,"pageSize":10,"agentCode":"","agentName":"","settleStatus":"","settleMonthBegin":"","settleMonthEnd":"","amountBegin":"","amountEnd":""}}
